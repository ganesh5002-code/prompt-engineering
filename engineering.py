...
def temperature_prompt_activity():
    ...
    prompts = [
        ...
        f"Explain {topic} as if I'm 5-10 years of age",
        f"Tell me if {topic} will be useful or not",
        f"Create Propoganda about {topic}"
    ]
    ...
    for i, p in enumerate(prompts, 1):
        ...
        print("\n REFLECTION: ")
        print("1) How did the prompts become more specific?")
        print("2) Was the context improved with the temperature?")
        print("3) Which prompt felt most useful and why?")
        print("\nAs a challenge, create a prompt chain")
